...
class Drive:
    def __init__(self):
        ...
        #f = open("/home/nvidia/drive_params.txt", "r")
...
#        else:
            ...
            self.enc_data[3] = -(msg.data)[1]    #back right
    ...
    def joyCallback(self, msg):
        ...
        if (self.steer_islocked == True and self.full_potential_islocked == True):
            ...
            self.steering_ctrl_unlocked = [msg.buttons[self.parallel_btn],msg.buttons[self.rotinplace_btn]]    #for relative 45 (or any function buttons should perform)
