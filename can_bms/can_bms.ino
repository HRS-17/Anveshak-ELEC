...
void setup() {
  ...
  if (ads1_ok) {send_status_message("I:48");}
  else {send_status_message("E:48");}
  if (ads2_ok) {send_status_message("I:49");}
  else {send_status_message("E:49");}
  if (ads3_ok) {send_status_message("I:4A");}
  else {send_status_message("E:4A");}

  if (can_ok) {send_status_message("I:CAN");}
  else {send_status_message("E:CAN");}  
}
...
void send_status_message(const char* text) {
  ...
  msg.identifier = diagnostic_identifier;  // diagnostic ID
